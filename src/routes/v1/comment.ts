...
const groupAndIdParam = z.object({
...
registry.registerPath({
  ...
  responses: { 201: { description: "댓글 생성 성공" } },
});
registry.registerPath({
  method: "get",
  path: "/api/v1/comment/{groupId}/{noticeId}/list",
  tags: ["Comment"],
  summary: "댓글 목록 조회",
  ...auth,
  request: {
    params: z.object({ groupId: z.string().uuid() }),
    query: z.object({ noticeId: z.string().uuid() }),
  },
  responses: { 200: { description: "댓글 목록" } },
});
registry.registerPath({
  method: "get",
  path: "/api/v1/comment/{groupId}/{id}",
  tags: ["Comment"],
  summary: "댓글 단건 조회",
  ...auth,
  request: { params: groupAndIdParam },
  responses: {
    200: { description: "댓글 정보" },
...
registry.registerPath({
  ...
  summary: "댓글 수정",
  ...auth,
  request: { params: groupAndIdParam, ...body(updateCommentSchema) },
  responses: {
...
router.get("/:groupId/:noticeId/list", async (req, res, next) => {
